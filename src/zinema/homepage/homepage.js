...
function Homepage(){
    ...
    const url_action = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&with_genres=28`;

    const url_adventure = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&with_genres=12`;

    const url_animation = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&with_genres=16`;

    const url_crime = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&with_genres=80`;

    const url_documentary = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&with_genres=99`;

    const url_mystery = `https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&with_genres=9648`;

    const url_action_adventure_TV = `https://api.themoviedb.org/3/discover/tv?api_key=${API_KEY}&with_genres=10759`;

    const url_crime_tv = `https://api.themoviedb.org/3/discover/tv?api_key=${API_KEY}&with_genres=80`;

    const url_comedy_tv = `https://api.themoviedb.org/3/discover/tv?api_key=${API_KEY}&with_genres=35`;
        ...
        <div className="homepage_navigation">
            ...
            <div className="row ">
                ...
                <div className="col-10">
                    ...
                    {profile.userType === 'PREMIUM' || profile.userType === 'BASIC' || profile.userType === 'ADMIN'? (

                        <div>

                        <div className="row">

                            <MovieRow title="Action" url={url_action}/>

                        </div>

                        <div className="row">

                        <MovieRow title="Adventure" url={url_adventure}/>

                        </div>

                        <div className="row">

                        <MovieRow title="Animation" url={url_animation}/>
                    ...
                    {profile.userType === 'PREMIUM' || profile.userType === 'ADMIN'? (

                        <div>

                        <div className="row">

                            <MovieRow title="Crime" url={url_crime}/>

                        </div>

                        <div className="row">

                            <MovieRow title="Documentaries" url={url_documentary}/>

                        </div>

                        <div className="row">

                            <MovieRow title="Mystery" url={url_mystery}/>
                    ...
                    {profile.userType === 'ADMIN'? (
                        ...
                        <div className="row">
                            ...
                            <MovieRow title="Action TV shows" url={url_action_adventure_TV}/>

                        </div>

                        <div className="row">

                            <MovieRow title="Crime TV shows" url={url_crime_tv}/>

                        </div>

                        <div className="row">

                            <MovieRow title="Comedy TV shows" url={url_comedy_tv}/>
